...
public class Request {
	...
	public static Request Delete(final URI uri) {
		return new Request(new InternalEntityEnclosingHttpRequest(HttpDelete.METHOD_NAME, uri));
	}

	public static Request Delete(final String uri) {
		return new Request(new InternalEntityEnclosingHttpRequest(HttpDelete.METHOD_NAME, URI.create(uri)));
	}
	...
	HttpResponse internalExecute(final HttpClient client, final HttpContext localContext)
		...
		return client.execute(target, this.request, localContext);
	}
	...
	public Response execute(HttpClient client) throws ClientProtocolException, IOException {
		return new Response(internalExecute(client, null));
	}
	...
	public Request target(final HttpHost target) {
		this.target = target;
		return this;
	}
