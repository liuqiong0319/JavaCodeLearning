 ...
 * {@link org.apache.http.HttpResponse} messages to
 * {@link Content} instances.
 *
 * @see Content
 *
 * @since 4.4
...
public class ContentResponseHandler extends AbstractResponseHandler<Content> {
	...
	public Content handleEntity(final HttpEntity entity) throws IOException {
		return entity != null ? new Content(EntityUtils.toByteArray(entity), ContentType.getOrDefault(entity))
				: Content.NO_CONTENT;
	}
