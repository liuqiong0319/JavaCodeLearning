...
import java.learning.self.collectionDemo.domain.Person;
import java.learning.self.collectionDemo.domain.Student;
import java.learning.self.collectionDemo.domain.Worker;
