...
public class ValueToStringJsonTokener extends JSONTokener {
	...
	public ValueToStringJsonTokener(String in, boolean useOriginalType) {
		super(in);
	...
	private Object readLiteral() throws JSONException {
		...
		} else if ("true".equalsIgnoreCase(literal) || "false".equalsIgnoreCase(literal)) {
			return literal;
		}
